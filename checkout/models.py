...
class Order(models.Model):
    ...
    # using CountryField to give dropdown of countries for ISO 3166 codes
    ...
    # so that if same customer orders same thing, we can identify if same order or not
    ...
    def update_total(self):
        ...
        # or 0 so that order total will be 0 not None if all line items manually deleted
...
class OrderLineItem(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        """
        # set the total for each line item to price by quantity
